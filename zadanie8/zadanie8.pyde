...
def setup():
    size(220,100)
    global library, Karolina
    books = ["Naocznosc", "Sens Sztuki", "Harry Potter", "Kasacja"]
    library = Library(books) 
    Karolina = Customer() # zastąpiłaś zamiast dodać
...
def mouseClicked():  
    if mouseX >100 and mouseX<200:
        if mouseY >10 and mouseY <30:
            library.lendBook(Karolina.requestBook("Naocznosc"))        
        if mouseY >40 and mouseY <60:
            library.addBook(Karolina.returnBook())
